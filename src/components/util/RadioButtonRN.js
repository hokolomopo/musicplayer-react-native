...
class RadioButtonRN extends React.Component {
    ...
    _onAnimationEnd = () => {
        if(this.props.onAnimationEnd != null && (this.initialAnimationDone !== undefined || this.props.initialOnAnimationEnd == true))
...
RadioButtonRN.propTypes = {
    ...
    initialOnAnimationEnd : PropTypes.bool
};
